...
export function init() {
  ...
  if (!inited) {
    ...
    let caseBlock = new Block(BlockTypes.CASE, "d163fbd7-4b34-4e22-85c7-4b4554713770", -100, -50, "case-t4");
    let screenBlock = new Block(BlockTypes.SCREEN, "ac3635dc-6e85-474c-bcf1-ec8b8ef419b3", 100, -40, "screen-t2");
    let driveBlock = new Block(BlockTypes.DRIVE, "dfd01a26-de2f-442f-bc62-6cdeed76a7c8", 50, 150, "drive");
