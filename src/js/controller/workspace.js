...
export function init() {
  ...
  if (!inited) {
    ...
    let caseBlock = new Block("d163fbd7-4b34-4e22-85c7-4b4554713770", -100, -50, "case-t4", [{ id: "on", texture: "case-on", visible: true }]);
    let screenBlock = new Block("ac3635dc-6e85-474c-bcf1-ec8b8ef419b3", 100, -40, "screen-t2", [{ id: "on", texture: "screen-on", visible: true }]);
